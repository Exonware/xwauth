...
1. Document **access token** lifetime and **refresh** rotation behavior today vs target (`access_token_lifetime`, `refresh_token_lifetime`, env overrides on xwauth-connector-api).  
