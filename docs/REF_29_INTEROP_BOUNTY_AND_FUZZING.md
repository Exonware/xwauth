...
**Machine-readable:** `exonware.xwauth.connector.ops.research_program` (`interop_bounty_policy`, `fuzzing_recommendations`)  
...
We do **not** ship a fuzz binary; use **Hypothesis** (property tests), **Atheris**, or HTTP black-box tools against a local **xwauth-connector-api** instance.
