...
**Machine-readable checklist:** `exonware.xwauth.ops.email_magic_link_ops.magic_link_email_ops_checklist()`  
...
```python
from exonware.xwauth.ops import magic_link_email_ops_checklist, recommended_magic_link_ttl_seconds_bounds
...
- xwauth magic-link handlers are wired via **xwlogin** (`exonware.xwlogin.handlers.mixins.magic_link`); this REF is **transport-agnostic** ops guidance.
