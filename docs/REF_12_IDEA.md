# Idea Reference â€” exonware-xwauth-connector (XWOAuth)
...
**XWOAuth (xwauth)** is the **centralized, universal authorization system** for eXonware: library + APIs + UIs; supports OAuth 1, OAuth 2, OIDC, future standards (e.g. DCE), **more connectors than any other system** (target **â‰¥100**); seamless Exonware integration (xwstorage.connect, xwbase, all future APIs); backward compatibility with legacy systems; replaces Firebase Auth and more. **DX:** Extremely short and seamless code; really small, really powerful, highest efficiency. **Performance:** Extremely fast using all Exonware libraries. This document captures product direction and ideas; approved ideas flow to [REF_22_PROJECT.md](REF_22_PROJECT.md) and [REF_13_ARCH.md](REF_13_ARCH.md).
...
- **Usability (top priority):** Developer experience â€” extremely short, seamless; small surface; powerful; highest efficiency.
...
**Related Documents:**
- [REF_01_REQ.md](REF_01_REQ.md) â€” Requirements (source)
- [REF_22_PROJECT.md](REF_22_PROJECT.md) â€” Project requirements
- [REF_13_ARCH.md](REF_13_ARCH.md) â€” Architecture
- [REF_14_DX.md](REF_14_DX.md) â€” Developer experience
- [REF_15_API.md](REF_15_API.md) â€” API reference
- [REF_35_REVIEW.md](REF_35_REVIEW.md) â€” Review summary

---

## Product Direction (from REF_01 / REF_22)

### âœ… [IDEA-001] Centralized universal authorization system (XWOAuth)

**Status:** âœ… Approved â†’ Implemented (evolving)  
**Date:** 08-Feb-2026
...
**Proposed Solution:** xwauth as XWOAuth â€” not only a library but authorization system with APIs and UIs; OAuth1, OAuth2, OIDC, SAML, future standards; **â‰¥100 connectors**; xwentity, xwstorage.connect, xwaction, xwbase integration; extend auth provider for legacy systems; Firebase Auth replacement.

**Outcome:** Implemented (M1â€“M3 done); M5 (â‰¥100 connectors) and M6 (new standards + performance) in scope.

---

### âœ… [IDEA-002] Maximum connectors (â‰¥100)

**Status:** âœ… Approved â†’ In progress  
**Date:** 08-Feb-2026
...
### âœ… [IDEA-003] Developer experience â€” extremely short, seamless

**Status:** âœ… Approved â†’ In progress  
**Date:** 08-Feb-2026

**Problem:** Auth must be trivial for developers â€” minimal code, small surface, powerful, highest efficiency.

**Proposed Solution:** Facade and layered API; 1â€“3 line happy paths for authenticate/token; really small, really powerful; highest efficiency; clear REF_15_API and REF_14_DX.

**Outcome:** REF_14_DX and REF_15_API define key code and easy vs advanced; M6 DoD includes DX validation.

---

### âœ… [IDEA-004] Performance â€” extremely fast (Exonware libs)
...
### âœ… [IDEA-005] Backward compatibility and Firebase replacement

**Status:** âœ… Approved â†’ In scope  
**Date:** 08-Feb-2026
