...
- Prefer a **CHANGELOG** or GitHub **Releases** notes per package (`exonware-xwauth-connector`, `exonware-xwauth-identity`, `exonware-xwauth-connector-api`) so security rows in [SECURITY_ADVISORIES.md](../SECURITY_ADVISORIES.md) can link to “what changed.”
