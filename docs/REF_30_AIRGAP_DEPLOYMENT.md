...
**Purpose:** REF_25 #17 — run **xwauth / xwlogin / xwauth-connector-api** without outbound internet access.  
**Machine-readable checklist:** `exonware.xwauth.connector.ops.airgap_deployment.airgap_deployment_checklist()`  
