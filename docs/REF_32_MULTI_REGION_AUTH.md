...
**Checklist API:** `exonware.xwauth.ops.multi_region_auth.multi_region_auth_checklist()`  
...
- JWKS refetch behavior in code: `exonware.xwauth.federation.oidc_id_token` (`jwks_refetch_on_verify_failure`)
