...
**Purpose:** REF_25 #11 — accelerate **DPA**, **ROPA**, and **subprocessor** conversations for deployments using xwauth / xwauth-connector-api.  
**API:** `exonware.xwauth.connector.ops.compliance_pack` — `compliance_pack_checklist()`, `compliance_evidence_template()`  
