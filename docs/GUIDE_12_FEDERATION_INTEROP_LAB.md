...
|-------|----------------|--------|
| **A. In-repo protocol suites** | AS/OIDC/SCIM behavior against **TestClient** + matrix tests | `xwauth-connector-api` `protocol-conformance.yml`, `test_oauth_interop_matrix.py`, `test_oauth_endpoint_matrix.py` |
