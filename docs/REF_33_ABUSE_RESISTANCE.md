...
**Checklist:** `exonware.xwauth.ops.abuse_resistance.abuse_resistance_checklist()`  
**Helper:** `exonware.xwauth.ops.abuse_resistance.exponential_backoff_delay_ms`  
...
- **Handlers:** xwauth mixins already declare ``rate_limit`` strings; enforce them in **xwaction** / **xwauth-api** engines and at the **edge**.
...
- Ops telemetry: `xwauth-api` route families and anomaly endpoints
