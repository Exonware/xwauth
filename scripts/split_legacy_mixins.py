...
LEGACY = Path("src/exonware/xwauth/api/services/_legacy.py")
MIXINS = Path("src/exonware/xwauth/api/services/mixins")
...
def main():
    ...
    for name, (start, end) in SLICES.items():
        ...
        header = f'''# exonware/xwauth/api/services/mixins/{name}.py
"""{DESCRIPTIONS[name]}."""
