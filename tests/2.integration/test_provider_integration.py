#!/usr/bin/env python3
"""
#exonware/xwauth.connector/tests/2.integration/test_provider_integration.py
...
class TestProviderIntegration:
    ...
    def auth(self):
        ...
        config = XWAuthConfig(jwt_secret="test-secret-key-for-provider-integration", allow_mock_storage_fallback=True)
