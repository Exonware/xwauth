#!/usr/bin/env python3
"""
#exonware/xwauth.connector/tests/2.integration/test_multi_provider_flow.py
...
from exonware.xwauth.connect.providers.apple import AppleProvider
...
class TestMultiProviderFlow:
    ...
    def auth(self):
        ...
        config = XWAuthConfig(jwt_secret="test-secret-key-for-multi-provider", allow_mock_storage_fallback=True)
