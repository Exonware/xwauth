#!/usr/bin/env python3
"""
#exonware/xwauth.connector/tests/2.integration/test_oauth2_integration.py
...
from exonware.xwauth.identity.storage.mock import MockStorageProvider, MockUser
