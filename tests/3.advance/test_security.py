#!/usr/bin/env python3
"""
#exonware/xwauth.connector/tests/3.advance/test_security.py
...
class TestOWASPCompliance:
    ...
    def test_password_strength_validation(self):
        ...
        config = XWAuthConfig(jwt_secret="test-secret-for-security-tests", allow_mock_storage_fallback=True)
