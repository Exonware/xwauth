#!/usr/bin/env python3
"""
#exonware/xwauth/tests/1.unit/jose_tests/test_jose_library.py
...
from exonware.xwauth.errors import XWInvalidTokenError, XWExpiredTokenError
...
class TestJWAManager:
    ...
    def test_get_supported_algorithms(self, jwa_manager):
        ...
        from exonware.xwauth.jose.jwa import JWAAlgorithm
