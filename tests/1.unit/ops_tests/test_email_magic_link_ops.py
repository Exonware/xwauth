#!/usr/bin/env python3
"""Tests for exonware.xwauth.connector.ops.email_magic_link_ops (REF_25 #16)."""
...
from exonware.xwauth.identity.ops.email_magic_link_ops import magic_link_email_ops_checklist as raw_checklist
