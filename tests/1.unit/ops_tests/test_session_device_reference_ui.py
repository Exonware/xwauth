#!/usr/bin/env python3
"""Tests for exonware.xwauth.ops.session_device_reference_ui (REF_25 #14)."""
...
from exonware.xwauth.ops.session_device_reference_ui import session_device_reference_ui_checklist as raw
