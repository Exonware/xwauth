#!/usr/bin/env python3
"""Tests for exonware.xwauth.ops.kubernetes_operator_readiness (REF_25 #4)."""
...
from exonware.xwauth.ops.kubernetes_operator_readiness import kubernetes_operator_readiness_checklist as raw
