#!/usr/bin/env python3
"""Tests for exonware.xwauth.connector.ops.admin_api_openapi_parity (REF_25 #7)."""
...
from exonware.xwauth.identity.ops.admin_api_openapi_parity import admin_api_openapi_parity_checklist as raw
