#!/usr/bin/env python3
"""Tests for exonware.xwauth.ops.infra_as_code_tenants (REF_25 #3)."""

from __future__ import annotations

import pytest

from exonware.xwauth.ops import INFRA_AS_CODE_TENANTS_SCHEMA_VERSION, infra_as_code_tenants_checklist
from exonware.xwauth.ops.infra_as_code_tenants import infra_as_code_tenants_checklist as raw
