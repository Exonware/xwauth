#!/usr/bin/env python3
"""Tests for exonware.xwauth.connector.ops.data_residency (REF_25 #12)."""

from __future__ import annotations

import pytest

from exonware.xwauth.identity.ops import DATA_RESIDENCY_OPS_SCHEMA_VERSION, data_residency_checklist
from exonware.xwauth.identity.ops.data_residency import data_residency_checklist as raw
