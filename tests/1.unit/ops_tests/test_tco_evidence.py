#!/usr/bin/env python3
"""Tests for exonware.xwauth.ops.tco_evidence (REF_25 #19)."""
...
from exonware.xwauth.ops.tco_evidence import tco_benchmark_publish_checklist as raw_chk
...
def test_tco_publish_checklist_shape() -> None:
    ...
    assert ids == {"environment", "xwauth_microbench", "xwauth_api_http", "tco_narrative"}
