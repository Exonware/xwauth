#!/usr/bin/env python3
"""Tests for exonware.xwauth.connector.ops.extension_model_readiness (REF_25 #8)."""
...
from exonware.xwauth.identity.ops.extension_model_readiness import extension_model_readiness_checklist as raw
