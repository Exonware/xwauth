#!/usr/bin/env python3
"""Tests for exonware.xwauth.connector.ops.multi_region_auth (REF_25 #18)."""

from __future__ import annotations

import pytest

from exonware.xwauth.identity.ops import MULTI_REGION_AUTH_OPS_SCHEMA_VERSION, multi_region_auth_checklist
from exonware.xwauth.identity.ops.multi_region_auth import multi_region_auth_checklist as raw
