#!/usr/bin/env python3
"""Tests for exonware.xwauth.ops.compliance_pack (REF_25 #11)."""
...
from exonware.xwauth.ops.compliance_pack import compliance_evidence_template as raw_tpl
from exonware.xwauth.ops.compliance_pack import compliance_pack_checklist as raw_chk
