#!/usr/bin/env python3
"""Tests for exonware.xwauth.ops.airgap_deployment (REF_25 #17)."""

from __future__ import annotations

import pytest

from exonware.xwauth.ops import AIRGAP_OPS_SCHEMA_VERSION, airgap_deployment_checklist
from exonware.xwauth.ops.airgap_deployment import airgap_deployment_checklist as raw_checklist
