#!/usr/bin/env python3
"""Tests for exonware.xwauth.connector.ops.pen_test_engagement (REF_25 #1)."""

from __future__ import annotations

import pytest

from exonware.xwauth.identity.ops import PENTEST_ENGAGEMENT_SCHEMA_VERSION, pen_test_engagement_checklist
from exonware.xwauth.identity.ops.pen_test_engagement import pen_test_engagement_checklist as raw
