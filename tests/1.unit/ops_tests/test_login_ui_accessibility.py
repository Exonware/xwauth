#!/usr/bin/env python3
"""Tests for exonware.xwauth.connector.ops.login_ui_accessibility (REF_25 #10)."""

from __future__ import annotations

import pytest

from exonware.xwauth.identity.ops import LOGIN_UI_A11Y_SCHEMA_VERSION, login_ui_accessibility_checklist
from exonware.xwauth.identity.ops.login_ui_accessibility import login_ui_accessibility_checklist as raw
