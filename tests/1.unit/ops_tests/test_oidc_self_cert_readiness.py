#!/usr/bin/env python3
"""Tests for exonware.xwauth.ops.oidc_self_cert_readiness (REF_25 #2)."""
...
from exonware.xwauth.ops.oidc_self_cert_readiness import oidc_self_cert_readiness_checklist as raw
