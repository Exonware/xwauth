#!/usr/bin/env python3
"""
#exonware/xwauth.connector/tests/1.unit/authorization_tests/runner.py
Authorization Tests Module Runner
...
def main():
    ...
    runner = TestRunner(
        library_name="xwauth",
        layer_name="1.unit.authorization_tests",
        description="Authorization System Unit Tests",
        test_dir=test_dir,
