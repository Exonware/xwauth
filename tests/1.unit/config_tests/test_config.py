#!/usr/bin/env python3
"""
#exonware/xwauth/tests/1.unit/config_tests/test_config.py
...
class TestXWAuthConfig:
    ...
    def test_config_validation(self):
        ...
        config = XWAuthConfig(jwt_secret=None)
    ...
    def test_protocol_profile_b_requires_fapi_profile_flags(self):
        config = XWAuthConfig(jwt_secret="test-secret", protocol_profile="B")
