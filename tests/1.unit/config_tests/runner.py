#!/usr/bin/env python3
"""
#exonware/xwauth.connector/tests/1.unit/config_tests/runner.py
Configuration Tests Module Runner
...
def main():
    ...
    runner = TestRunner(
        library_name="xwauth",
        layer_name="1.unit.config_tests",
        description="Configuration Unit Tests",
        test_dir=test_dir,
