...
#exonware/xwauth.connector/tests/1.unit/integrations_tests/test_framework_integrations.py
...
class TestFastAPIIntegration:
    ...
    def test_fastapi_dependencies_import(self):
        ...
        try:
            ...
            from exonware.xwauth.identity.integrations.fastapi import get_current_user, require_auth
    ...
    def test_fastapi_integration_structure(self):
        ...
        try:
            ...
            from exonware.xwauth.identity.integrations import fastapi
...
class TestFlaskIntegration:
    ...
    def test_flask_middleware_import(self):
        ...
        try:
            ...
            from exonware.xwauth.identity.integrations.flask import require_auth, get_current_user
            assert require_auth is not None
    ...
    def test_flask_integration_structure(self):
        ...
        try:
            ...
            from exonware.xwauth.identity.integrations import flask
...
class TestDjangoIntegration:
    ...
    def test_django_auth_backend_import(self):
        ...
        try:
            ...
            from exonware.xwauth.identity.integrations.django import auth_backend
    ...
    def test_django_drf_integration_import(self):
        ...
        try:
            ...
            from exonware.xwauth.identity.integrations.django import drf
...
class TestORMHelpers:
    ...
    def test_sqlalchemy_mixins_import(self):
        ...
        try:
            ...
            from exonware.xwauth.identity.integrations.sqlalchemy import mixins
    ...
    def test_django_orm_models_import(self):
        ...
        try:
            ...
            from exonware.xwauth.identity.integrations.django_orm import models
