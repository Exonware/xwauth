#!/usr/bin/env python3
"""
#exonware/xwauth.connector/tests/1.unit/integrations_tests/runner.py
Framework Integrations Tests Module Runner
...
def main():
    """Run framework integrations unit tests."""
    os.chdir(_PKG_ROOT)
    test_dir = Path(__file__).parent
    runner = TestRunner(
        library_name="xwauth",
        layer_name="1.unit.integrations_tests",
        description="Framework Integrations Unit Tests",
        test_dir=test_dir,
