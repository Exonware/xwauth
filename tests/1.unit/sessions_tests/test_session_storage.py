#!/usr/bin/env python3
"""
#exonware/xwauth.connector/tests/1.unit/sessions_tests/test_session_storage.py
...
from exonware.xwauth.identity.sessions.storage import SessionStorage
from exonware.xwauth.identity.sessions.session import Session
