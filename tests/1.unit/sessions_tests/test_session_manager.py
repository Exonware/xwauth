#!/usr/bin/env python3
"""
#exonware/xwauth.connector/tests/1.unit/sessions_tests/test_session_manager.py
...
from exonware.xwauth.identity.errors import XWSessionExpiredError, XWSessionError, XWInvalidRequestError
