#!/usr/bin/env python3
"""
#exonware/xwauth.connector/tests/1.unit/sessions_tests/runner.py
Session Tests Module Runner
...
def main():
    ...
    runner = TestRunner(
        library_name="xwauth",
        layer_name="1.unit.sessions_tests",
        description="Session Management Unit Tests",
        test_dir=test_dir,
