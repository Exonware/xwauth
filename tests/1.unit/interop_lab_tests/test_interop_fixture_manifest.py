#!/usr/bin/env python3
"""
# exonware/xwauth/tests/1.unit/interop_lab_tests/test_interop_fixture_manifest.py
...
def test_redacted_scim_users_list_fixture_shape() -> None:
    ...
    from exonware.xwauth.scim.models import SCIM_LIST_RESPONSE_SCHEMA, SCIM_USER_SCHEMA
