#!/usr/bin/env python3
"""
#exonware/xwauth.connector/tests/1.unit/errors_tests/runner.py
Error Handling Tests Module Runner
...
def main():
    ...
    runner = TestRunner(
        library_name="xwauth",
        layer_name="1.unit.errors_tests",
        description="Error Handling Unit Tests",
        test_dir=test_dir,
