#!/usr/bin/env python3
"""
#exonware/xwauth.connector/tests/1.unit/tokens_tests/runner.py
Token Tests Module Runner
...
def main():
    """Run token management unit tests."""
    os.chdir(_PKG_ROOT)
    test_dir = Path(__file__).parent
    runner = TestRunner(
        library_name="xwauth",
        layer_name="1.unit.tokens_tests",
        description="Token Management Unit Tests",
        test_dir=test_dir,
