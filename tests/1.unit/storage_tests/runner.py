#!/usr/bin/env python3
"""
#exonware/xwauth.connector/tests/1.unit/storage_tests/runner.py
Storage Tests Module Runner
...
def main():
    """Run storage integration unit tests."""
    os.chdir(_PKG_ROOT)
    test_dir = Path(__file__).parent
    runner = TestRunner(
        library_name="xwauth",
        layer_name="1.unit.storage_tests",
        description="Storage Integration Unit Tests",
        test_dir=test_dir,
