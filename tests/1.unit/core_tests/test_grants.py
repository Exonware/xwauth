#!/usr/bin/env python3
"""
#exonware/xwauth.connector/tests/1.unit/core_tests/test_grants.py
...
from exonware.xwauth.identity.core.grants.authorization_code import AuthorizationCodeGrant
from exonware.xwauth.identity.core.grants.client_credentials import ClientCredentialsGrant
from exonware.xwauth.identity.core.grants.resource_owner_password import ResourceOwnerPasswordGrant
from exonware.xwauth.identity.core.grants.device_code import DeviceCodeGrant
from exonware.xwauth.identity.core.grants.refresh_token import (
    RefreshTokenGrant,
    _refresh_metadata_for_issue,
)
from exonware.xwauth.identity.core.grants.authorization_code import _refresh_metadata_from_code_attrs
