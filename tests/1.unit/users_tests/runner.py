#!/usr/bin/env python3
"""
#exonware/xwauth.connector/tests/1.unit/users_tests/runner.py
User Management Tests Module Runner
...
def main():
    ...
    runner = TestRunner(
        library_name="xwauth",
        layer_name="1.unit.users_tests",
        description="User Management Unit Tests",
        test_dir=test_dir,
