#!/usr/bin/env python3
"""
#exonware/xwauth/tests/1.unit/users_tests/test_user_edge_cases.py
...
from exonware.xwauth.errors import XWUserNotFoundError, XWUserAlreadyExistsError, XWUserError
