#!/usr/bin/env python3
"""
#exonware/xwauth.connector/tests/1.unit/security_tests/runner.py
Security Tests Module Runner
...
def main():
    ...
    runner = TestRunner(
        library_name="xwauth",
        layer_name="1.unit.security_tests",
        description="Security Features Unit Tests",
        test_dir=test_dir,
        pytest_cwd=_PKG_ROOT,
        markers=["xwauth_unit", "xwauth_security"]
    )
    return runner.run()
