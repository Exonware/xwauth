#!/usr/bin/env python3
"""
#exonware/xwauth.connector/tests/1.unit/defs_tests/runner.py
Definitions Tests Module Runner
...
def main():
    """Run definitions unit tests."""
    os.chdir(_PKG_ROOT)
    test_dir = Path(__file__).parent
    runner = TestRunner(
        library_name="xwauth",
        layer_name="1.unit.defs_tests",
        description="Definitions Unit Tests",
        test_dir=test_dir,
