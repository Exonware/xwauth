#!/usr/bin/env python3
"""
#exonware/xwauth.connector/tests/1.unit/facade_tests/test_facade.py
...
from exonware.xwauth.identity.errors import XWAuthError, XWOAuthError
...
from exonware.xwauth.identity.scim import ScimService
