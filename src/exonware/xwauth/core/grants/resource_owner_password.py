...
from ...defs import GrantType
from ...errors import XWOAuthError, XWInvalidRequestError, XWInvalidCredentialsError
from .base import ABaseGrant
...
class ResourceOwnerPasswordGrant(ABaseGrant):
    ...
    async def process(self, request: dict[str, Any]) -> dict[str, Any]:
        ...
        from exonware.xwauth.handlers import _common as _handler_common
