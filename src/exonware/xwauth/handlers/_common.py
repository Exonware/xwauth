...
def _load_login_auth_factories() -> Any:
    try:
        from exonware.xwlogin.handlers import connector_auth_factories as _m
...
def get_audit_log_manager(auth):
    ...
    from exonware.xwauth.audit.manager import AuditLogManager
...
def require_client_auth(
    ...
    if secret and (not client_secret or client_secret != secret):
