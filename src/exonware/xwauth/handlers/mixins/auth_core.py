...
from exonware.xwauth.ops_hooks import notify_critical_handler, track_critical_handler
from .._common import (
    AUTH_TAGS,
    OAUTH2_PREFIX,
    get_auth,
...
async def par(request: Request) -> Any:
    ...
    try:
        async with track_critical_handler(request, "oauth2_par"):
            ...
            from exonware.xwauth.core.par import PARManager
...
async def logout(request: Request) -> Any:
    ...
    try:
        async with track_critical_handler(request, "oidc_logout"):
            ...
            from exonware.xwauth.core.logout import LogoutManager
