#!/usr/bin/env python3
"""
#exonware/xwauth.connector/src/exonware/xwauth.connector/providers/registry.py
Provider Registry
...
from exonware.xwauth.connect.errors import XWProviderError, XWProviderNotFoundError
