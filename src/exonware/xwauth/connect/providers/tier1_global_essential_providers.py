#!/usr/bin/env python3
"""
# exonware/xwauth/connect/providers/tier1_global_essential_providers.py
...
class AppleIcloudWebStub(_EnterpriseIamStub):
    ...
    _hint = "For third-party apps use :class:`~exonware.xwauth.connect.providers.apple.AppleProvider` (Sign in with Apple) or Apple ID web flows per Apple docs."
