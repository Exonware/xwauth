# exonware/xwauth.identity/handlers/mixins/sso_providers.py
"""
SSO OAuth callbacks.
...
from exonware.xwauth.connect.api_paths import AUTH_PREFIX
from exonware.xwauth.connect.handlers._common import PROVIDERS_TAGS, get_auth, get_user_lifecycle
from exonware.xwauth.connect.oauth_http.errors import oauth_error_to_http
...
def get_provider_callback_routes(auth: Any, auth_prefix: str) -> list[tuple[str, str, Callable[..., Any]]]:
    ...
    """
    from exonware.xwauth.connect.providers.callback_providers import get_oauth2_callback_provider_names
