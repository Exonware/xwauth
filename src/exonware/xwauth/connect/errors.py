#!/usr/bin/env python3
"""
#exonware/xwauth.connector/src/exonware/xwauth.connector/errors.py
...
class XWStorageConnectError(XWAuthError):
    """Storage provider errors."""
    pass


class XWStorageConnectConnectionError(XWStorageConnectError):
    """Storage connection error."""
    pass


class XWStorageConnectOperationError(XWStorageConnectError):
