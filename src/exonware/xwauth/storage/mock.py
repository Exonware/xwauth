...
of xwauth without requiring xwstorage. Uses in-memory storage.
...
class MockStorageProvider:
    ...
    Provides in-memory storage functionality without requiring xwstorage:
    - In-memory user storage
    - In-memory session storage
    - In-memory token storage
    - In-memory audit log storage
    This allows xwauth to be developed and tested independently
    before integrating with xwstorage's real implementation.
    """
