...
Defines the IStorageProvider interface for dependency inversion with xwstorage.
This allows xwauth to work independently with a mock implementation,
then integrate with xwstorage's real implementation later.
...
class IStorageProvider(IBasicProviderStorage, Protocol):
    ...
    - xwstorage implements IStorageProvider
    - xwauth uses IStorageProvider (not xwstorage directly)
    """
    # ==========================================================================
    # USER OPERATIONS
    # ==========================================================================
